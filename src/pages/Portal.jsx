...
const Portal = () => {
  ...
  return (
    <div>
      ...
      {/* {application?.status === 'Submitted' && <div>hi</div>} */}
      {/* Close Applications */}
      ...
      {application?.status === 'Accepted' && (
        ...
        >
          <h3 style={{ textAlign: 'center' }}>
            ...
            that you are coming in order for us to be better prepared!
          </h3>
          <button class="accept" onClick={() => confirmUser(application?.id)}>
            I Confirm
          </button>

          <h3 style={{ textAlign: 'center' }}>
            If your plans have changed and can no longer attend BostonHacks,
            please decline.
          </h3>
          <button class="decline" onClick={() => declineUser(application?.id)}>
            I Decline
          </button>
        </div>
      )}
      ...
      {application?.status === 'Confirmed' && (
        ...
        >
          <h3 style={{ textAlign: 'center' }}>
            Thank you for confirming your spot at BostonHacks 2022. Keep an eye
            out for important emails from us. FAQ and our schedule can be found
            at bostonhacks.io, we will see you at the event!
          </h3>
          <h3 style={{ textAlign: 'center' }}>
            Please bring a screenshot of the QR code below for check in with us!
          </h3>
          <img
            className="img-fluid"
            src={qrCode}
