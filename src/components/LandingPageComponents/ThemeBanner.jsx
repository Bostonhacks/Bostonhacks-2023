...
const Word = ({ children, image }) => {
  return(
    <div className="relative flex items-center justify-center">
      <h2 className="mb-3 md:m-5 md:mb-8 p-5 z-50 text-center relative pb-1">{ children }</h2>
...
const ThemeBanner = () => {
  return (
    <div className="flex justify-around flex-row items-center mx-3 my-[10rem] md:mx-[15%] font-misterpixel">
        <img alt="star" className="mb-[5rem] w-auto h-[30px] md:w-[95x] md:h-[95px]" src={Star}/>
        ...
        <img alt="star" className="mt-[10rem] md:mt-[15rem] w-[30x] h-[30px] md:w-[95x] md:h-[95px]" src={Star}  />
    </div>
  )
}
