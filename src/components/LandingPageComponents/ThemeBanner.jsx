...
const ThemeBanner = () => {
  return (
    <div className="flex justify-around flex-row items-center mx-10 my-[10rem] lg:mx-[20%] font-misterpixel">
        <img alt="star" className="mb-[5rem]" />
        ...
        <div className="flex flex-col items-center justify-center">
            ...
            <div className="grid grid-rows-2 grid-cols-3 text-4xl text-center gap-x-4 lg:text-[80px] lg:leading-[90px]">
        ...
        <img alt="star" className="mt-[5rem]" />
    </div>
  )
}
