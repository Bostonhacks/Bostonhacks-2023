  ...
  return (
    <div className="flex justify-center items-center flex-col w-full">
      ...
      >
        ...
        <img src={cloudtop} className="relative md:block left-96 max-sm:hidden" alt="cloudtop"/>
        <img src={cloudleft} className="absolute md:block left-0 max-sm:hidden" alt="cloudleft"/>
      <img src={cloudright} className="absolute md:block right-0 max-sm:hidden" alt="cloudright"/>
    </div>
  );
}
